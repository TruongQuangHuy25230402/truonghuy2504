...
cred = credentials.Certificate("./iuh-20066991-firebase-adminsdk-drec1-b880deb818.json")
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20066991').where(u'DEALSIZE', u'==', 'Large').stream())
    ...
    children=[
        html.Div(
            children=[
                ...
                html.H3(
                    children="IUH-DHHTTT16B-20066991-Trương Quang Huy", className="header-title"
                )
            ],
            className="header",
        ),
